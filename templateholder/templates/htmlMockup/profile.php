    ...
    function display_table() {        
		$result = get_profile_info();
			foreach ($result as $row) {
				echo "<tr>" . "<td>" . "<h2><b>Username: </b></h2>" . "<h3>" . $row[0] . "</h3>" . "</td>" . "</tr>";
				echo "<tr>" . "<td>" . "<h2><b>First Name: </b></h2>" . "<h3>" . $row[1] . "</h3>" . "</td>" . "</tr>";
				echo "<tr>" . "<td>" . "<h2><b>Last Name: </b></h2>" . "<h3>" . $row[2] . "</h3>" . "</td>" . "</tr>";
				echo "<tr>" . "<td>" . "<h2><b>Address: </b></h2>" . "<h3>" . $row[3] . "</h3>" . "</td>" . "</tr>";
				echo "<tr>" . "<td>" . "<h2><b>State: </b></h2>" . "<h3>" . $row[4] . "</h3>" . "</td>" . "</tr>";
				echo "<tr>" . "<td>" . "<h2><b>Phone: </b></h2>" . "<h3>" . $row[5] . "</h3>" . "</td>" . "</tr>";
				echo "<tr>" . "<td>" . "<h2><b>About Me: </b></h2>" . "<h3>" . $row[6] . "</h3>" . "<br><br><br><br><br>" . "</td>" . "</tr>";
        }
    }
?>
<!doctype html>
